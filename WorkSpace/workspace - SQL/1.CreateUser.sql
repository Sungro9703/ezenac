-- 오라클 구버전 방식으로 사용자 계정 생성을 위한 설정
ALTER SESSION SET "_ORACLE_SCRIPT" = TRUE;

CREATE USER ezen IDENTIFIED BY 0824;
...
datafile 'C:\app\Ro\product\18.0.0\oradata\XE\ezen_data.dbf' SIZE 2G
...
tempfile 'C:\app\Ro\product\18.0.0\oradata\XE\ezen_temp.dbf' SIZE 500M
