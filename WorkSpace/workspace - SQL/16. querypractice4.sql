...
-- DEPT_CD, DEPT_NM, 가장 늦은 생일, 가장 빠른 생일, 직원 수)
SELECT A.DEPT_CD 
...
-- 사원번호, 사원명, 최대급여액수, 최소급여액수, 평균 급여 액수를 출력하시오
SELECT A.EMP_NO
...
-- CASE WHEN
SELECT 
	SUM(CASE WHEN BIRTH_DE LIKE '195%' THEN 1 ELSE 0 END) "1950년대생" 
	,SUM(CASE WHEN BIRTH_DE LIKE '196%' THEN 1 ELSE 0 END) "1960년대생"
	,SUM(CASE WHEN BIRTH_DE LIKE '197%' THEN 1 ELSE 0 END) "1970년대생"
	,SUM(CASE WHEN BIRTH_DE LIKE '198%' THEN 1 ELSE 0 END) "1980년대생"
	,SUM(CASE WHEN BIRTH_DE LIKE '199%' THEN 1 ELSE 0 END) "1990년대생"
	,COUNT(*) CNT 
FROM TB_EMP
;
...
SELECT
	DEPT_CD 
	,(SELECT DEPT_NM FROM TB_DEPT B WHERE B.DEPT_CD  = A.DEPT_CD) AS DEPT_NM
	,SUM(CASE WHEN BIRTH_DE LIKE '195%' THEN 1 ELSE 0 END) "1950년대생" 
	,SUM(CASE WHEN BIRTH_DE LIKE '196%' THEN 1 ELSE 0 END) "1960년대생"
	,SUM(CASE WHEN BIRTH_DE LIKE '197%' THEN 1 ELSE 0 END) "1970년대생"
	,SUM(CASE WHEN BIRTH_DE LIKE '198%' THEN 1 ELSE 0 END) "1980년대생"
