...
<body>
	...
	<%
		Cookie cookie = new Cookie("ezenCookie", "쿠키주세요");		//쿠키 이름, 값
		cookie.setPath(request.getContextPath()); 	//쿠키가 적용될 경로 지정
													//chap08_JSP 웹애플리케이션 전체에서 쿠키 사용
		cookie.setMaxAge(3600);		//쿠키가 유지될 기간을 초단위로 설정
