 ...
 * Generated at: 2022-05-30 03:06:23 UTC
...
public final class popupMain02_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String popupMode = "on"; 
	...
	if(cookies != null){
      ...
      out.write("				$('#popup').hide();				/* 팝업창을 숨김 처리*/\r\n");
      out.write("				/* [오늘 하루 열지 않음]을 체크했는지 확인하여\r\n");
      out.write("				   쿠키를 설정 --popupCookie.jsp를 실행\r\n");
      out.write("				*/\r\n");
      out.write("				// id가 inactiveToday이면서 checked 체크박스 					/ 값을 읽어옴\r\n");
      out.write("				let chkVal = $('input:checkbox[id=inactiveToday]:checkde').val();\r\n");
      out.write("				\r\n");
      out.write("				// jQuery의 ajax() 함수: 비동기 HTTP 요청을 보내는 함수\r\n");
      out.write("				$.ajax({						//4) 비동기 요청 보냄\r\n");
      ...
      out.write("					dataType:\"text\",			//5) 서버로부터 받을 응답 데이터의 타입은 일반 텍스트\r\n");
      out.write("					success: function(resData){	// 6) 요청 성공 시 실행할 롤백 함수\r\n");
      ...
      out.write("					<input type=\"checkbox\" id=\"inactiveToday\" value=\"1\" />하루동안 열지 않음\r\n");
