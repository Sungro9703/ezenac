...
<body>
	...
	<c:if test="${13 == 13 }">		<!-- 조건식에 비교 연산자 사용 -->
		<h4>두 값은 같습니다.</h4>
	</c:if>
	...
	<c:if test="ezen" var="result3">
		EL이 아닌 일반 값이 오면 무조건 false를 반환<br />
	</c:if>
	result3: ${result3 }<br />
	
	<c:if test="true" var="result4">
		EL이 아닌 일반 값으로 true가 사용되는 것은 예외<br />
	</c:if>
	result4: ${result4 }<br />
	
	<c:if test="tRuE" var="result5">
		EL이 아닌 일반 값으로 true가 대소문자에 상관없이 인식 <br />
	</c:if>
	result5: ${result5 }<br />
</body>
</html>